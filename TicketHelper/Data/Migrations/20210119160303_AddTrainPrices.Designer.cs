...
namespace TicketHelper.Data.Migrations
{
    ...
    [Migration("20210119160303_AddTrainPrices")]
    partial class AddTrainPrices
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketHelper.Domain.CarriageType", b =>
                {
                    b.Property<int>("CarriageTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TicketHelper.Domain.Schedule", b =>
                {
                    ...
                    b.HasIndex("TrainId", "StationId", "Date")
                        .IsUnique();
            ...
            modelBuilder.Entity("TicketHelper.Domain.Schedule", b =>
                {
                    b.HasOne("TicketHelper.Domain.Station", "Station")
                        .WithMany("Schedule")
